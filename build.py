...
<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-col footer-about">
      ...
      <p class="footer-desc">은평구 전지역 출장마사지·홈타이 방문 예약 안내 사이트입니다.</p>
      ...
      <div class="footer-cta">
        <a class="footer-cta-btn" href="{TELEGRAM_BUILD}" target="_blank" rel="noopener nofollow">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.3l15.97-6.16c.73-.33 1.43.18 1.15 1.3l-2.72 12.81c-.19.91-.74 1.13-1.5.71l-4.15-3.06-1.99 1.93c-.23.23-.42.42-.83.42z"/></svg>
          웹사이트 제작문의</a>
    ...
    <nav class="footer-col" aria-label="지역 안내">
      ...
      <ul>
        <li><a href="/seoul/eunpyeong-gu/">지역별 안내</a></li>
        <li><a href="/seoul/eunpyeong-gu/station/">역세권 안내</a></li>
        <li><a href="/seoul/eunpyeong-gu/area/">생활권 안내</a></li>
        <li><a href="/massage/">홈타이 이용 가이드</a></li>
